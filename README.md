...
```
### Step 3 — Cooking Phase WITHOUT lock — shows the problem (shared memory + synchronization)
```bash
python kitchen.py --no-lock
```

### Step 4 — Cooking Phase WITH lock — shows the fix (shared memory + synchronization)
```bash
